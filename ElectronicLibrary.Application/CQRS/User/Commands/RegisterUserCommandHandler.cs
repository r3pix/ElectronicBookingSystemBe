...
namespace ElectronicLibrary.Application.CQRS.User.Commands
{
    public class RegisterUserCommandHandler : IRequestHandler<RegisterUserCommand>
    {
        ...
        public RegisterUserCommandHandler(IRepository<ElectronicBookingSystem.Domain.Entities.User> userRepository, IMapper mapper, IPasswordHasher<ElectronicBookingSystem.Domain.Entities.User> passwordHasher, IRepository<ElectronicBookingSystem.Domain.Entities.Role> roleRepository, IEmailSender emailSender) 
        {
        ...
        public async Task<Unit> Handle(RegisterUserCommand request, CancellationToken cancellationToken)
        {
            ...
            await _emailSender.SendEmailAsync(entity.Email,"Założenie konta","Założyłeś konto EZ");
            return default;
        }
    }
}
